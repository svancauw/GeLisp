...
%rename(GlIntVar_copy) GlIntVar(const GlIntVar& var); //SHOULDN'T BE USED FROM LISPWORKS
...
//CLASS GLGRAPHVAR
%rename(GlCPRelVar_default) GlCPRelVar(void); //SHOULDN'T BE USED FROM LISPWORKS
%rename(GlCPRelVar_copy) GlCPRelVar(const GlCPRelVar& var);
%rename(GlCPRelVar_grelation) GlCPRelVar(GlSpace& home, const MPG::CPRel::GRelation& l, const MPG::CPRel::GRelation& u);
...
%rename(Tuple_arity) Tuple(int k);
%rename(Tuple_binary) Tuple(int a, int b);
%rename(Tuple_ternary) Tuple(int a, int b, int c);

/******************************************** propagators ********************************************************/

%rename(equal_rel) equal(Gecode::Space& home, CPRelVar A, CPRelVar B);

%rename(comp_rel) complement(Gecode::Space& home, CPRelVar A, CPRelVar B);

%rename(union_rel) Union(Gecode::Space& home, CPRelVar A, CPRelVar B, CPRelVar C);
